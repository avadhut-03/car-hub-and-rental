...
$query ="SELECT * FROM   bokking_deatils";
$data = mysqli_query($conn,$query );

$total= mysqli_num_rows($data);


echo $result["name"]." ".$result["email"]." ".$result["phone"]." ".$result["location"]." ".$result["selectcar"]." ".$result["date"]." ".$result["time"];
